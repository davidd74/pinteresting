  ...
  return (
    <div className="mt-28">
      <div className="flex flex-col justify-center items-center">
        ...
        {/* buttons */}
        <div className="mt-12 flex text-lg font-medium xs:gap-6 md:gap-8 lg:gap-12">
          <button
      ...
      <div className="flex flex-col-reverse xs:justify-center pt-16">
          ...
          (createdPosts.length <= 0 ? (
            <p className="text-center font-semibold text-xl">{`${
              userId === user.sub
                ...
                : "The user hasn't created any posts yet."
            }`}</p>
          ) : null)}
        {!showCreated &&
          (savedPosts.length <= 0 ? (
            <p className="text-center font-semibold text-xl">{`${
              userId === user.sub
                ...
                : "The user hasn't saved any posts yet."
            }`}</p>
          ) : null)}
      </div>
    </div>
